...
-- A complete relational database with constraints and relationships.
...
-- booking_addon table (M-M between booking and addon)
...
-- room_class_feature table (M-M between room_class and feature)
...
-- room_class_bed_type table (M-M between room_class and bed_type)
...
-- booking_room table (M-M between booking and room)
